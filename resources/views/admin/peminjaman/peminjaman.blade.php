                                ...
                                <form action="{{ route('admin.peminjaman.status', $p->id) }}" method="POST">
                                    ...
                                    <select name="status" class="form-select form-select-sm" onchange="this.form.submit()">
                                        <option value="menunggu"
                                            {{ strtolower($p->status) == 'menunggu' ? 'selected' : '' }}>Pending</option>
                                        <option value="disetujui"
                                            {{ strtolower($p->status) == 'disetujui' ? 'selected' : '' }}>Approved</option>
                                        <option value="ditolak"
                                            {{ strtolower($p->status) == 'ditolak' ? 'selected' : '' }}>Rejected</option>
                                    </select>
                                </form>
                            </td>
